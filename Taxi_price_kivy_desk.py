...
class Container(BoxLayout):
    ...
    def hbox1(self):
        ...
        for i in ['Пробег город, км', 'Пробег трасса, км',
            ...
            lb = Label(text=i, halign='left', valign='middle', size_hint=(0.64, 1),
                       pos_hint={'right': 0.79, 'center_y': 0.5}, font_size='18sp')
            lb.bind(size=lb.setter('text_size'))
            hb_v1.add_widget(lb)
            ti = TextInput(size_hint=(0.5, 1), pos_hint={'center_x': 0.5, 'center_y': 0.5})
    ...
    def hbox2(self):
        ...
        for i in ['Тариф город, руб', 'Тариф загород, руб', 'Посадка город, руб',
            ...
            lb = Label(text=i, halign='left', valign='middle', size_hint=(0.5, 1),
                       pos_hint={'right': 0.65, 'center_y': 0.5}, font_size='18sp')
            lb.bind(size=lb.setter('text_size'))
            hb_v1.add_widget(lb)
            ti = TextInput(size_hint=(0.5, 1), pos_hint={'center_x': 0.5, 'center_y': 0.5})
    ...
    def onPopup(self):
        ...
        bl_btn = Button(text='Закрыть', size_hint=[1, 0.25])
